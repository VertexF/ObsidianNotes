...
The difference between a point and a spot light lays in how $E$ is computed, and in particular how luminous intensity $I$ is computed from the luminous power $\Phi$

...
A **load** is, remember the first things is the destination.
```c
...
Were we take a base pointer, in this case `bp` and do some addition on it. This is known as an **effective address calculation**. These are an intel speciality even though they have changed they are still around now. This is not general, you have to be careful, you can't do `[ax + bx + 27]` for example.
# References
##### Main Notes

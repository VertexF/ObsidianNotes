...
Where the denominator is just working the visibility of the specular lighting for smith GGX. 
...
Heitz notes however that taking the height of the microfacets into account correlate with masking and shadowing which leads to more accurate results. Remember $X^{+}(a)$ is the heavside function  where 1 if a>0 and 0 otherwise.

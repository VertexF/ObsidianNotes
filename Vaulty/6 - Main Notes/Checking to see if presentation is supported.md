...
When checking for queue families you need to also check for presentation queue families too. It's possible for you to find graphics queue family and that queue family **NOT** support presentation. You need if you want graphics to be displayed.

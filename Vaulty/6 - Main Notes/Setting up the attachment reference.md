...
Every subpass need an **VkAttachmentReference** which describes the output of the shader in it's location and format for a given subpass operation. This describes the output of the fragment shader, so when you write 

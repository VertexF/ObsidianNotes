...
Fences work similarly to binary semaphores. They are either signalled or unsignalled. When work is finished with a fense we can signal it which means the host can continue on because we know the GPU is up to date with the host now.

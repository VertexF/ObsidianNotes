...
A subpass is a collection of render operation that happen in sequence and that also depend on the framebuffer's previous frame/pass. For example sequence of post-processing events can happen within a subpass.

...
You only need to worry about the **VK_API_VERSION** here as this changes what is available to you as the programmer. Newer version might not be supported on people graphics cards/devices. If you're interested you can see them listed here: https://vulkan.gpuinfo.org/
# References
##### Main Notes

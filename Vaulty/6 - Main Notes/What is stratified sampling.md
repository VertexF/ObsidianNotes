...
Were $X_{ij}$ within a nested for loop for each stratum by pixel density $p_i$ So if you add all the strata together you get this where $F=\sum_i v_i F_i$ where $v_i$ is the $i$th fractional volume.
# References
##### Main Notes

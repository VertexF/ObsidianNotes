...
I'm making this note to show what's in this createBuffer function which is used everywhere. This function just creates a buffer. That's all it does. It combined both [[Setting up a vulkan buffer]] and [[Allocating data to a buffer]] into a function.

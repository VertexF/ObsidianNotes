...
Remember a single queue family can have more than one queue type. It's common for GPUs to have a queue family with everything in including the graphics queue and a separate transfer queue for example.
# References
##### Main Notes

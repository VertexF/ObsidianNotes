...
This is complication that can happen if you pass in a pointer **INTO** a function that's dealing with shared data. Whether your using OOP or strict DOD it's bad. You need to consider how to you access data.

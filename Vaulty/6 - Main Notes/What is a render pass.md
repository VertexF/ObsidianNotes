...
The render pass is a key part of the graphics pipeline. We need framebuffer attachments that we will to use while rendering. The render pass handles a couple of things.
- The colour and depth buffers
- How many samples there will be for each buffer.
- How should the buffers and the samples be used for the rendering operation.

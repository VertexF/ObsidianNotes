# Reference https://www.computerenhance.com/p/opcode-patterns-in-8086-arithmetic
...
##### Jump if not zero
You have this instruction `jnz` jumps to somewhere. To decode this you just look at the opcode and the 8 bit displacement. It's very simple to decode unlike everything else. There are no-conditional jumps and they work different to `jnz`. 

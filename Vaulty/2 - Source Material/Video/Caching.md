# Reference https://www.computerenhance.com/p/caching
...
There are many other things that have to be done to get those adds to happen. You have to consider load and stores when it comes to algorithm. A load is when you get something from memory and a store is when you put something in memory.
